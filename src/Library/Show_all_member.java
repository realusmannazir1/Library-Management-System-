...
public class Show_all_member extends javax.swing.JFrame {
   ...
   ConnectionTest zak = new ConnectionTest();
    ...
    private void initComponents() {
        ...
        label1.setText("Search A Student By (ID OR Name)");
        ...
        jLabel3.setText("                                                    All Available Students");
       ...
       DefaultTableModel model = (DefaultTableModel) std_table.getModel();
        ...
        try {
           try (Connection con = DriverManager.getConnection(url, user, passs)) {
               Statement st = con.createStatement();
               String query = "SELECT std_id,name,department,semister FROM members WHERE name LIKE '" + search + "%' OR std_id = '" + search + "'";
